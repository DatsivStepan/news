    ...
    <main class="main">
        <div class="content">
            <div class="bread">
                ...
                <span property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" title="Go to the {{ $news->getCategoryName() }} category archives." href="https://www.nta.ua/news/" class="taxonomy category">
                        <span property="name">{{ $news->getCategoryName() }}</span>
                    </a>
